...
const BottomNav: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-4 left-0 right-0 z-50 px-3 safe-area-bottom">
      <div className="mx-auto max-w-md rounded-full border border-border/60 bg-card/92 backdrop-blur-xl shadow-[0_12px_28px_-10px_rgba(0,0,0,0.35)]">
          ...
          {NAV_ITEMS.map(({ path, icon: Icon, label }) => {
            ...
            return (
              <button
                ...
                type="button"
                className={cn(
                  "group relative flex h-12 flex-col items-center justify-center rounded-full transition-all",

    ...
    <>
      <PageShell title="표현 모음">
        {migrationRequired ? (
          ...
          <div className="rounded-[var(--radius-lg)] border bg-card p-8 text-center">
            ...
            {items.map((item) => {
              ...
              return (
                <button
                  key={item.id}
                  type="button"
                  className="w-full rounded-[var(--radius-lg)] border bg-card p-3 text-left hover:border-primary/40 transition-colors"
                  onClick={() =>
